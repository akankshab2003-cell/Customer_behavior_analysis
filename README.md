...
Performed initial inspection of schema and data types.

Exploratory Data Analysis (EDA)

Analyzed distributions, trends, and correlations.

Identified missing values, outliers, and data quality issues.
...
Wrote SQL queries to answer key analytical questions.

Created aggregated tables/views for reporting.
...
Identified meaningful trends and patterns using SQL.

Delivered insights through an interactive Power BI dashboard.
